...
def _compute_heuristic_risk(
    ...
    from app.services.risk_service import compute_risk_from_record
    agent_context = get_agent_context(record)
    is_agentic = isinstance(agent_context, dict) and agent_context.get("sessionKind") == "agentic"
    return compute_risk_from_record(record, is_agentic=is_agentic)
