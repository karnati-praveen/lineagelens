...
Write-Host "  releases/base/lineagelens-base-$newVersion.zip"
Write-Host "  releases/plus/lineagelens-plus-$newVersion.zip"
Write-Host "  releases/max/lineagelens-max-$newVersion.zip"
